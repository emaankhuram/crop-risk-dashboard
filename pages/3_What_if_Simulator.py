...
def load_model():
    try:
        ...
        st.error("⚠️ Model file not found! Please ensure random_forest_model.pkl is in the 'models/' folder.")
        return None

st.title("🎛️ What-If Scenario Simulator")
st.markdown("### Adjust climate parameters and see how predictions change in real-time")

st.info("""
**How to use this simulator:**
1. Adjust the sliders below to simulate different climate scenarios
2. See the predicted impact on yield volatility in real-time
3. Experiment with different combinations to understand risk factors
""")
...
with col_output:
    ...
    fig = go.Figure(go.Indicator(
        ...
        delta={'reference': 5.0, 'increasing': {'color': "#e74c3c"}},
        gauge={
...
st.markdown("### 💡 Understanding Your Scenario")
...
with col2:
    ...
    if prediction > 10:
        ...
        **⚠️ HIGH RISK SCENARIO**
        ...
        This scenario suggests severe impacts:
        - Consider drought-resistant varieties
        - Invest in irrigation infrastructure
        - Increase crop insurance coverage
        ...
        **🟠 ELEVATED RISK SCENARIO**
        ...
        Moderate adaptation strategies needed:
        - Monitor weather forecasts closely
        - Adjust planting/harvesting timing
        ...
        **✅ MANAGEABLE SCENARIO**
        ...
        Current practices likely sufficient:
        - Continue best management practices
        - Stay informed on climate trends
        - Maintain crop diversification
        - Regular soil testing
        """)

# Scenario presets
st.markdown("---")
st.markdown("### 🎯 Try These Preset Scenarios")

col1, col2, col3 = st.columns(3)

with col1:
    if st.button("🌡️ Extreme Heat Wave"):
        st.experimental_rerun()

with col2:
    if st.button("💧 Drought Conditions"):
        st.experimental_rerun()

with col3:
    if st.button("🌪️ High Variability"):
        st.experimental_rerun()
...
with st.expander("📚 Learn More About These Parameters"):
    ...
    **Temperature Variability (Most Important!)**
    - Measures how erratic temperature is during growing season
    - High variability = unpredictable heat stress
    - Research shows this matters MORE than average warming
    
    **Extreme Heat Days**
    - Days above 30°C during critical growth stages
    - Can damage pollen viability and reduce yields dramatically
    - Even 2-3 extra days can have significant impact
    
    **NDVI (Normalized Difference Vegetation Index)**
    - Satellite measure of vegetation health
    - Ranges from -1 to 1, higher = healthier
    - Direct indicator of crop stress
    
    **Baseline Volatility**
    - Historical yield variability
    - Counties with high baseline volatility are more vulnerable
    - "Path dependency" effect
    
    ### Why This Matters
    Understanding these relationships helps:
    - Target adaptation resources efficiently
